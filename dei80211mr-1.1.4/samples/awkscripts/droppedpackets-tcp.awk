...
dropped_n0_noise++;
else if(layer=="MAC" && flags=="TXA")
dropped_n0_txa++;
else if(layer=="MAC" && flags=="SYN")
dropped_n0_syn++;
else if(layer=="MAC" && flags=="DUP")
dropped_n0_dup++;
else
dropped_n0_other++;
}
...
{
printf("%f %d %d %d %d %d %d\n", time, dropped_n0_ifq_temp, dropped_n1_ifq_temp, dropped_n2_ifq_temp,dropped_n3_ifq_temp,dropped_n4_ifq_temp,
dropped_n0_ifq_temp+dropped_n1_ifq_temp+dropped_n2_ifq_temp+dropped_n3_ifq_temp+dropped_n4_ifq_temp) > dropped_queue_file;
...
printf("For node 0, AP dropped packets %d, arp %d, ifq %d, mac ret %d, mac col %d, mac busy %d, mac interf %d, mac noise %d, tx active %d, syn failed %d, dup %d, others %d\n", dropped_n0, dropped_n0_arp,
dropped_n0_ifq,dropped_n0_macret,dropped_n0_macbsy,dropped_n0_maccol,dropped_n0_interf, dropped_n0_noise,dropped_n0_txa, dropped_n0_syn, dropped_n0_dup, dropped_n0_other);

printf("For node 1, AP dropped packets %d, arp %d, ifq %d, mac ret %d, mac col %d, mac busy %d, mac interf %d, mac noise %d, tx active %d, syn failed %d, dup %d, others %d\n", dropped_n1, dropped_n1_arp,
dropped_n1_ifq,dropped_n1_macret,dropped_n1_macbsy,dropped_n1_maccol,dropped_n1_interf, dropped_n1_noise,dropped_n1_txa, dropped_n1_syn, dropped_n1_dup, dropped_n1_other);

printf("For node 2, AP dropped packets %d, arp %d, ifq %d, mac ret %d, mac col %d, mac busy %d, mac interf %d, mac noise %d, tx active %d, syn failed %d, dup %d, others %d\n", dropped_n2, dropped_n2_arp,
dropped_n2_ifq,dropped_n2_macret,dropped_n2_macbsy,dropped_n2_maccol,dropped_n2_interf, dropped_n2_noise,dropped_n2_txa, dropped_n2_syn, dropped_n2_dup, dropped_n2_other);

printf("For node 3, AP dropped packets %d, arp %d, ifq %d, mac ret %d, mac col %d, mac busy %d, mac interf %d, mac noise %d, tx active %d, syn failed %d, dup %d, others %d\n", dropped_n3, dropped_n3_arp,
dropped_n3_ifq,dropped_n3_macret,dropped_n3_macbsy,dropped_n3_maccol,dropped_n3_interf, dropped_n3_noise,dropped_n3_txa, dropped_n3_syn, dropped_n3_dup, dropped_n3_other);

printf("For node 4, AP dropped packets %d, arp %d, ifq %d, mac ret %d, mac col %d, mac busy %d, mac interf %d, mac noise %d, tx active %d, syn failed %d, dup %d, others %d\n", dropped_n4, dropped_n4_arp,
dropped_n4_ifq,dropped_n4_macret,dropped_n4_macbsy,dropped_n4_maccol,dropped_n4_interf, dropped_n4_noise,dropped_n4_txa, dropped_n4_syn, dropped_n4_dup, dropped_n4_other);
